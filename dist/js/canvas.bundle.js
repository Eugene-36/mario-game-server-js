...
canvas.width = 1024;
canvas.height = 576;
var gravity = 0.5; //! Создаём класс игрока
...
var Player = /*#__PURE__*/function () {
  ...
  _createClass(Player, [{
    key: "draw",
    value: function draw() {
      c.drawImage(this.currentSprite, this.currnetCropWidth * this.frames, 0, this.currnetCropWidth, 400, this.position.x, this.position.y, this.width, this.height);
    }
  }, {
    key: "update",
    value: function update() {
      ...
      if (this.frames > 59 && (this.currentSprite === this.sprites.stand.right || this.currnetSprite === this.sprites.stand.left)) {
        this.frames = 0;
